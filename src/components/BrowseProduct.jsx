  ...
  return (
    ...
    >
      ...
      <div id="Desc" class="text-black text-[13px] line-clamp-9">
        ...
        quis eu etiam duis ut. Semper sapien at nunc leo. Non mauris suspendisse
        amet adipiscing adipiscing. Facilisi amet risus cursus nisi mi integer.
        Purus aliquam pretium sit odio. Faucibus nec velit cursus donec ut in
        non porta. Fermentum vel velit mattis cras tincidunt aliquam. Nulla
        tortor sodales diam quam semper cras tincidunt metus. Varius sed id sit
        ipsum at dui porttitor leo. Sit urna risus egestas aliquam sit sit
        viverra. Ut dolor viverra tempus est egestas sed. Consectetur porttitor
        arcu mauris adipiscing dignissim. Dolor hac enim pellentesque blandit
        auctor nisl euismod. Metus auctor mi ut mollis donec quis. Rutrum id
        diam etiam ac tincidunt et. Dolor venenatis massa.
      </div>
    </div>
  );
};
