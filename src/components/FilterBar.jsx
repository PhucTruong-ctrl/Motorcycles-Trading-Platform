  ...
  return (
    <div className="w-full md:w-fit h-fit flex flex-col justify-start items-center gap-3.5 p-6 bg-white rounded-[6px] shadow-md shadow-grey">
      ...
      <div className="flex lex-row justify-center items-start md:items-center self-stretch gap-2.5 ">
        <div className="flex justify-center items-center w-[80px] h-[45px] bg-blue rounded-[6px] shadow-md shadow-grey">
          <img src="/icons/Tune.svg" alt="" className="w-[35px]" />
        </div>
        <div className="flex justify-center items-center w-[80px] h-[45px] bg-black rounded-[6px] shadow-md shadow-grey">
      ...
      <div className="flex flex-col items-start gap-1 self-stretch">
        ...
        <div className="flex flex-row justify-start md:justify-between items-center gap-2.5 self-stretch">
          <div className="flex justify-center items-center px-6 py-2 max-w-[70px] rounded-[6px] font-light italic text-[18px] text-white bg-blue shadow-md shadow-grey">
            All
          </div>
          <div className="flex justify-center items-center px-6 py-2 max-w-[70px] rounded-[6px] font-light italic text-[18px] text-white bg-black shadow-md shadow-grey">
            New
          </div>
          <div className="flex justify-center items-center px-6 py-2 max-w-[70px] rounded-[6px] font-light italic text-[18px] text-white bg-black shadow-md shadow-grey">
            Used
