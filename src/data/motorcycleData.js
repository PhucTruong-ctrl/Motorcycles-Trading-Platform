  ...
  BMW: {
    naked: [
      ...
      },
      {
        model: "R nineT",
        trims: [
          { name: "Standard", engine_size: "1170" },
          { name: "Pure", engine_size: "1170" },
          { name: "Scrambler", engine_size: "1170" },
          { name: "Urban G/S", engine_size: "1170" },
          { name: "Racer", engine_size: "1170" },
        ],
      },
      {
        model: "S1000R",
    ...
    scooters: [
      { model: "C400X", trims: [{ name: "Standard", engine_size: "350" }] },
      { model: "C400GT", trims: [{ name: "Standard", engine_size: "350" }] },
      { model: "CE04", trims: [{ name: "Standard", engine_size: "125" }] },
    ],
    underbones: [
      { model: "G310R", trims: [{ name: "Standard", engine_size: "313" }] },
      { model: "G310GS", trims: [{ name: "Standard", engine_size: "313" }] },
      { model: "G310RR", trims: [{ name: "Standard", engine_size: "313" }] },
    ],
  },
  Ducati: {
    naked: [
    ...
    underbones: [
      {
        model: "Raider 150",
        trims: [
          { name: "Standard", engine_size: "147" },
          { name: "Fi", engine_size: "147" },
        ],
      },
      {
        model: "Satria F150",
      ...
      { model: "Smash 110", trims: [{ name: "Standard", engine_size: "113" }] },
    ],
  },
};
